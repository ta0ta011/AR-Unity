...
namespace OpenCvSharp.Aruco
{
    ...
    public static class CvAruco
    {
        ...
        public static void DetectMarkers(InputArray image, Mat grayMat, Dictionary dictionary, out Point2f[][] corners, out int[] ids, DetectorParameters parameters, out Point2f[][] rejectedImgPoints)
        {
            if (image == null)
        ...
        internal static void DetectMarkers(Mat grayMat, Dictionary dictionary, out Point2f[][] corners, out int[] ids, DetectorParameters detectorParameters, out Point2f[][] rejectedImgPoints)
        {
